...
const HomePage = () => {
  ...
  // Refetch flag to avoid double updates
  ...
  // Refetch on mount only once to prevent double render issues
  useEffect(() => {
    if (location.pathname === "/" && !hasRefetched.current) {
      ...
      // Optional: reset flag in 2 sec (safe retry on future visits)
      setTimeout(() => {
      ...
      <div className="container mx-auto space-y-10">
        ...
        {loadingFriends ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
            {friends.map((friend) => (
              <FriendCard key={friend._id} friend={friend} authUser={authUser} />
            ))}
          </div>
        )}
